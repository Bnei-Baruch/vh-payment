  ...
  language: {
    ...
    he: {
      ...
      body: {
        title: "תיאור",
        description:
          ' חשבונית תתקבל במייל תוך יומיים מביצוע התשלום. אם תרצה להגדיל את התשלום החודשי בכדי לעזור לנו להרחיב את פעולת המערכת שלנו ולהראות הערכה נוספת למאמצינו, אתה יכול להשתמש ב"שלם לפי רצונך", כך שמי שיכול להרשות לעצמו לשלם יותר יכול לעשות זאת.',
      },
      cancel: {
        text: "ביטול",
        url: "https://kli.one/",
...
exports.tickets = {
  ...
  content: {
    en: {
      ...
      subtitle: "Connecting in the Ten - Adhering to the Creator, February 2026",
      action: "Select the type of ticket",
    },
    he: {
      title: "כנס \"קבלה לעם\" העולמי",
      subtitle: "מתחברים בעשירייה - נדבקים בבורא, פברואר 2026",
      action: "בחר כרטיס",
    },
    ru: {
      title: "Международный конгресс «Каббала ле-Ам»",
      subtitle: "Соединяемся в десятке — сливаемся с Творцом, Февраль 2026 г.",
      action: "Выберите вариант билета",
    },
    es: {
      title: "Congreso Mundial de \"Cabalá La'am\"",
      subtitle: "Conectándonos en la decena - adheridos al Creador, Febrero de 2026",
          ...
          options: [
            {
              ...
              type: "specialoption",
              payment_url: "https://www.vkruge.info/events/",
              register_status: {
                ukraine: "sp-ukraine",
                russia: "sp-russia",
              },
          ...
          options: [
            {
              ...
              intersticial: {
                ...
                russia: {
                  ...
                  body: "Зарегистрируйтесь и оплатить своё участие",
                },
              },
              type: "specialoption",
              payment_url: "https://www.vkruge.info/events/",
