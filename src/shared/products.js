...
exports.tickets = {
  ...
  content: {
    en: {
      ...
      subtitle: "Connecting to There Is None Else Besides Him, May 2025",
      action: "Select the type of ticket",
    },
    he: {
      title: "כנס \"קבלה לעם\" העולמי",
      subtitle: "מתחברים לאין עוד מלבדו, מאי 2025",
      action: "בחר כרטיס",
    },
    ru: {
      title: "Международный конгресс «Каббала ле-Ам»",
      subtitle: "Соединяемся с Нет Никого, кроме Него, Май 2025 г.",
      action: "Выберите вариант билета",
    },
    es: {
      title: "Congreso Mundial de \"Cabalá La'am\"",
      subtitle: "Conectándonos a No hay nada más que Él, Mayo de 2025",
