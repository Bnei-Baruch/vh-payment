...
exports.tickets = {
  ...
  content: {
    en: {
      ...
      subtitle: "Connecting to Lishma, February 2025",
      action: "Select the type of ticket",
    },
    he: {
      title: "כנס \"קבלה לעם\" העולמי",
      subtitle: "מתחברים ללשמה, פברואר 2025",
      action: "בחר כרטיס",
    },
    ru: {
      title: "Международный конгресс «Каббала ле-Ам»",
      subtitle: "Объединяемся в Лишма, Февраль 2025 г.",
      action: "Выберите вариант билета",
    },
    es: {
      title: "Congreso Mundial de \"Cabalá La'am\"",
      subtitle: "Conectándonos a Lishmá, Febrero de 2025",
